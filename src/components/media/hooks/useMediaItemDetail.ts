...
export interface UseMediaItemDetailProps {
    selectedItem?: MediaDetailItem | null;
    getChildrens?: (item: any) => Promise<Item[]>;
    handleRename?: (item: any, newTitle: string) => Promise<void>;
}

export function useMediaItemDetail(
    tab: UseMediaItemDetailProps,
    mediaType?: MediaType
) {
