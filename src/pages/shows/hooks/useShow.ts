...
export const useShow = () => {
    ...
    const getActionsForShow = (show: ShowResult): ActionItem[] => {
        ...
        actions.push({
            label: show.pinned ? SHOW_ACTION_MENU_LABELS.UNPIN : SHOW_ACTION_MENU_LABELS.PIN,
            icon: PIN_ICON_16,
            color: COLORS.PIN,
        ...
        actions.push({ label: SHOW_ACTION_MENU_LABELS.MARK_WATCHING, icon: EYE_ICON_16, color: COLORS.STATUS.SHOW.watching, onClick: () => updateStatus('watching') });
        actions.push({ label: SHOW_ACTION_MENU_LABELS.MARK_COMPLETED, icon: CHECK_CIRCLE_ICON_16, color: COLORS.STATUS.SHOW.completed, onClick: () => updateStatus('completed') });
        actions.push({ label: SHOW_ACTION_MENU_LABELS.MARK_PLANNED, icon: CALENDAR_ICON_16, color: COLORS.STATUS.SHOW.planned, onClick: () => updateStatus('planned') });
        actions.push({ label: SHOW_ACTION_MENU_LABELS.MARK_ON_HOLD, icon: PAUSE_CIRCLE_ICON_16, color: COLORS.STATUS.SHOW.on_hold, onClick: () => updateStatus('on_hold') });
        actions.push({ label: SHOW_ACTION_MENU_LABELS.MARK_DROPPED, icon: X_CIRCLE_ICON_16, color: COLORS.STATUS.SHOW.dropped, onClick: () => updateStatus('dropped') });
        actions.push({ label: SHOW_ACTION_MENU_LABELS.MARK_DEFAULT, icon: ROTATE_CCW_ICON_16, color: 'var(--text-muted)', onClick: () => updateStatus('default') });

        actions.push(ACTIONS_SEPARATOR);

        if (!show.banned) {
            actions.push({
                label: SHOW_ACTION_MENU_LABELS.BAN_SHOW,
                icon: BAN_ICON_16,
            ...
            actions.push({
                label: SHOW_ACTION_MENU_LABELS.UNBAN_SHOW,
