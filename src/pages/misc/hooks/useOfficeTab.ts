...
export const useOfficeTab = (misc: ReturnType<typeof useMisc>) => {
    ...
    const [officeTree, setOfficeTree] = useState<MiscDir[]>([]);
    const [currentOfficeDirHistory, setCurrentOfficeDirHistory] = useState<MiscDir[]>([]);
    ...
    const handleOfficeFolderClick = (folder: MiscDir) => {
