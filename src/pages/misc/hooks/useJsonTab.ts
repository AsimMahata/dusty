...
export const useJsonTab = (misc: ReturnType<typeof useMisc>) => {
    ...
    const [jsonTree, setJsonTree] = useState<MiscDir[]>([]);
    const [currentJsonDirHistory, setCurrentJsonDirHistory] = useState<MiscDir[]>([]);
    ...
    const handleJsonFolderClick = (folder: MiscDir) => {
