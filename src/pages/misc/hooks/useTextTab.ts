...
export const useTextTab = (misc: ReturnType<typeof useMisc>) => {
    ...
    const [textTree, setTextTree] = useState<MiscDir[]>([]);
    const [currentTextDirHistory, setCurrentTextDirHistory] = useState<MiscDir[]>([]);
    ...
    const handleTextFolderClick = (folder: MiscDir) => {
